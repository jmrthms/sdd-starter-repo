...
| 2 | AC2: *"The summary is concise."* | Concise is not a number, and the model does not respect it — the stub returns 70–95 words. Nothing enforces anything. | AC2: **at most 60 words, enforced server-side**, truncated on a word boundary. |
